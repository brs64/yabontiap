...
class Recette
{
    ...
    /**
     * Permet de construire un objet recette
     *
     * @param integer|null $id L'indentifiant de la recette
     * @param string|null $nom Le nom de la recette
     * @param string|null $description La description de la recette
     * @param string|null $image 
     * @param Categorie|null $categorie La categorie de la recette parmis entrée plat et dessert 
